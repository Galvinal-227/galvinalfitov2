  ...
  return (
    <motion.div animate={{ opacity: 1 }} initial={{ opacity: 0 }} transition={{ delay: 2, duration: 0.7 }} {...props}>
      <RoundedText
        ...
        textClassName="font-pixel !text-yellow-400 font-semibold capitalize"
        size={60}
        space={20}
      >
...
function NavigationLink({ onClose, linkTo, text, preview }: NavigationLinkProps) {
  ...
  return (
    <>
      ...
      >
        <StaggerSlideElementMenu className="font-pixel text-5xl font-light leading-[1] 2xl:text-8xl" tag="p" startDelay={0}>
          {text}
