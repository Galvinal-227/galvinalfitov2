  ...
  return (
    <div className={`relative w-full ${BLUR_HOVER_LINK}`}>
      ...
      <StaggerSlideElementMenu
        startDelay={1}
        className="mb-10 font-pixel text-3xl font-semibold leading-[1.2] md:mb-0 md:text-5xl lg:text-7xl"
        tag="h2"
      >
        GALVIN ALFITO
      </StaggerSlideElementMenu>
      <div className="mb-10 flex flex-col gap-2 md:hidden">
        <Link to="https://www.linkedin.com/in/GalvinAlfito/" target="_blank" className="flex items-end gap-2">
          ...
          <span className="font-pixel font-light underline">Linkedin</span>
        </Link>
        <Link to="https://github.com/galvinal-227" target="_blank" className="flex items-end gap-2">
          ...
          <span className="font-pixel font-light underline">Github</span>
        </Link>
        <Link to="mailto:galvinalfito@gmail.com" className="flex items-end gap-2">
          <MdEmail className="text-xl !text-primary" />
          <span className="font-pixel font-light underline">galvinalfito@gmail.com</span>
        </Link>
      </div>
      <StaggerSlideElementMenu
        startDelay={1.2}
