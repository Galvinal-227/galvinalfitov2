...
const CursorProvider = ({ children }: any) => {
  const [state, setState] = useState<State>({
    className: `fixed transition-opacity transform !bg-transparent -translate-x-1/2 -translate-y-1/2 !pointer-events-none flex items-center justify-center z-[9999]`,
