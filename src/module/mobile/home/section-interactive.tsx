    ...
    <section className="mt-[-100vh] min-h-screen bg-secondary">
      <div className="CONTAINER">
        ...
        <div className="h-[50vh]">
          <h2 className="MENU-CHANGE-Y-100 sticky top-[5%] font-pixel text-4xl font-medium text-primary md:text-6xl ">
        ...
        <motion.p style={{ y: scrollSpeedDesc }} className="CONTAINER pointer-events-none mt-20 text-justify text-2xl text-gray-700 ">
          {lang === 'id' ? (
            <>
              Halo, saya <span className="font-semibold text-primary">Galvin Alfito</span>, seorang{' '}
            ...
            <>
              Greetings, I&apos;m <span className="font-semibold text-primary">Galvin Alfito</span>, a seasoned{' '}
        ...
        <div className="h-[50vh]">
          <h2 className="MENU-CHANGE-Y-100 sticky top-[5%] mb-[10%] font-pixel text-4xl font-medium text-primary md:text-6xl ">
        ...
        <p className="CONTAINER MENU-CHANGE-Y-100 pointer-events-none mt-20 text-justify text-2xl text-gray-700 ">
          {lang === 'id' ? (
            <>
              Saya bukan sekadar <span className="font-pixel text-primary">developer</span>. Saya seorang pemecah masalah, pemikir kreatif, dan
            ...
            <>
              I&apos;m not just a <span className="font-pixel text-primary">developer</span>. I&apos;m a problem solver, a creative thinker, and a
              partner in your digital journey. Let&apos;s bring your <span className="font-pixel text-primary">ideas to life</span> and create
