...
export const StackedImage = () => {
  return (
    ...
    >
      <motion.img src="/me.png" alt="galvin alfito d" className="w-[80%] object-cover" />
      <motion.img src="/me.png" alt="galvin alfito d" className="absolute w-[70%] object-cover" />
      <motion.img src="/me.png" alt="galvin alfito d" className="absolute w-[60%] object-cover" />
    </motion.div>
  )
}
...
export default function SectionHeadMobile() {
  return (
    <div className="MENU-CHANGE-Y-100-STAGGER w-screen overflow-x-hidden">
      <motion.h1 style={{ x: -100 }} className="CHILD-STAGGER mt-2 whitespace-nowrap font-pixel text-2xl font-semibold text-secondary">
        ABOUT ME - ABOUT ME - ABOUT ME
      </motion.h1>
      <motion.h1 style={{ x: -200 }} className="CHILD-STAGGER mt-2 whitespace-nowrap font-pixel text-4xl font-semibold text-secondary">
        ABOUT ME - ABOUT ME - ABOUT ME
      </motion.h1>
      <motion.h1 style={{ x: -300 }} className="CHILD-STAGGER mt-2 whitespace-nowrap font-pixel text-6xl font-semibold text-secondary">
        ABOUT ME - ABOUT ME - ABOUT ME
      </motion.h1>
