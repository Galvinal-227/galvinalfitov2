    ...
    <>
      <div className="w-screen overflow-x-hidden">
        <MarqueeStagger
          ...
          startDelay={0.5}
          className="font-pixel text-9xl font-semibold text-secondary"
        >
      ...
      <div className="CONTAINER mt-20 min-h-[150vh]">
        <SpeedScrollElement speed={-300} options={{ offset: ['start center', 'end start'] }}>
          ...
          <SpeedScrollElement speed={-500} className=" pointer-events-none z-[90]">
            <StaggerSlideElementAbout className=" MENU-CHANGE-Y-200 pointer-events-none font-pixel text-[10rem] font-semibold leading-[1] text-white">
              GALVIN ALFITO
