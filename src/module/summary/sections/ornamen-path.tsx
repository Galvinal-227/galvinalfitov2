  ...
  if (state?.isSmallDevice) {
    return (
      <div className="CONTAINER flex h-screen items-center">
        <h2 className="MENU-CHANGE-Y-100 font-pixel text-7xl font-semibold capitalize text-white md:text-8xl">{t('summary_know_me')}</h2>
      </div>
    )
  }
  ...
  return (
    <div ref={ref} className="CONTAINER h-[650vh]">
      <div className="sticky left-0 top-[10%]">
        ...
        <motion.h2 style={{ opacity: opacityText }} className="MENU-CHANGE-Y-100 font-pixel text-9xl font-semibold capitalize text-white">
          {t('summary_know_me')}
        </motion.h2>
      </div>
    </div>
