...
const Description = () => {
  ...
  return (
    <div className="CONTAINER min-h-screen">
      <h1 className="MENU-CHANGE-SCALE-125 font-pixel text-6xl font-semibold text-secondary underline lg:text-8xl">Summary</h1>
      <div className="h-[20vh]"></div>
      <div className="flex flex-col">
        <h2 className="MENU-CHANGE-Y-100 font-pixel text-6xl font-semibold text-white lg:text-9xl">Galvin Alfito D</h2>
        <p className="MENU-CHANGE-Y-100 mt-4 font-pixel text-2xl text-secondary lg:text-3xl">
          - Want To MASTER Frontend | And Backend Development More -
        </p>
        
        <p className="MENU-CHANGE-Y-200 mt-10 text-justify font-pixel text-lg text-secondary lg:text-left lg:text-xl">
        ...
        <a href="/galvin_alfito_cv.pdf" target="_blank" download title="download cv" className="MENU-CHANGE-Y-200 mt-10 w-fit" rel="noreferrer">
          ...
          >
            ...
            <StaggerElementFooter
              ...
              perLetter
              tag="h2"
              className="pointer-events-none absolute left-1/2 top-1/2 z-10 m-0 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap font-pixel text-xl font-medium leading-[1.3] text-white"
            >
              Download CV
            </StaggerElementFooter>
            <StaggerElementFooter
